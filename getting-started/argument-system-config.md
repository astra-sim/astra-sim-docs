...
:::{note}
These fields relate to the native collective implementation in ASTRA-sim. Alternatively, users can also point to a custom collective implementation. For a detailed discussion on collective related inputs, refer to the [System Layer](../system-layer/sysinput.md) section.
:::
